  ...
  return (
    <MainDashboard>
      <div>
        ...
        />
        {/* Header */}
        <div className="mb-3 grid gap-3 md:flex md:justify-between md:items-center">
          <div></div>
          <div>
          ...
          <div className="rounded-xl border bg-card text-card-foreground shadow col-span-2">
            ...
            <div className="mr-8 ml-8">
              ...
              <div className="mb-5">
                ...
                <select
                  id="hs-select-label"
                  className="py-3 px-4 border pr-9 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                >
                  <option>Loan Period</option>
