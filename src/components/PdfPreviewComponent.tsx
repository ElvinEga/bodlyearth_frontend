...
const PdfPreviewComponent = ({ myRiskdata }: RiskDataProps) => {
        ...
        <div id="printablediv" className="pt-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 mt-3 border border-gray-200 p-4 rounded-lg  dark:border-gray-700">
            ...
            /> */}
              <MapWithMarker
                markerPosition={[
                  myRiskdata?.latitude || -0.3615164,
                  myRiskdata?.longitude || 35.3084548,
                ]}
              />
            </div>
            <div className="flex flex-col  items-center ">
              ...
              <Gauge level={myRiskdata?.composite_total_risk || 0} />
